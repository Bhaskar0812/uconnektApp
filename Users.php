...
//,$offset,$limit
    ...
    function updateExperience_post(){
        ...
        $set = array('current_job_title','current_company','current_start_date','current_description','next_availability','next_speciality','next_location','employementType');
        foreach ($set as $key => $val) {
        ...
        $exp_data['current_finish_date'] = $this->post('current_finish_date');
        ...
        if($is_exist){
            ...
            $exp_data['totalExperience'] = $getTotalExperience;
            ...
            $getTotalExperience = $this->Users_model->get_total_experience(PREVIOUS_EXPERIENCE,$where);
            $update_exper['totalExperience'] = $getTotalExperience;
        ...
        if($this->form_validation->run() == FALSE){
            ...
            if(!empty($user_info)){
                ...
                if($user_info->isNotify == 1){
                    $notif_msg = $this->send_push_notification($registrationIds, $title, $body_send, $review_for, $notif_type,$userType,$profileImage);
                }
    ...
    function addFavourites_post(){
        ...
        if($this->form_validation->run() == FALSE){
            ...
            if(!empty($user_info)){
                ...
                if($user_info->isNotify == 1){
                    $notif_msg = $this->send_push_notification($registrationIds, $title, $body_send, $favourite_for, $notif_type,$userType,$profileImage);
                }
    ...
    function addRecommends_post(){
        ...
        if($this->form_validation->run() == FALSE){
            ...
            if(!empty($user_info)){
                ...
                if($user_info->isNotify == 1){
                    $notif_msg = $this->send_push_notification($registrationIds, $title, $body_send, $recommend_for, $notif_type,$userType,$profileImage);
                }
    ...
    function addView_post(){
        ...
        if($this->form_validation->run() == FALSE){
            ...
            if($is_exist){
                $this->common_model->updateFields(VIEW,array('upd'=>datetime()),array('view_for'=>$insert_data['view_for']));
            ...
            if(!empty($user_info)){
                ...
                if($user_info->isNotify == 1){
                    $notif_msg = $this->send_push_notification($registrationIds, $title, $body_send,$current_user_id, $notif_type,$userType,$profileImage);
                }
    ...
    function getUserPersonalInfo_get(){
        ...
        if($updateDate == datetime()){
            ...
            $getTotalExperience = $this->common_model->getSingle(USER_EXPERIENCE,array('user_id'=>$user_id));
            $this->common_model->updateFields(USER_EXPERIENCE,array('totalExperience' => $getTotalExperience->totalExperience + 1),array('user_id'=> $user_id));
        }*/
        $resume =  !$this->Users_model->get_user_resume($where) ? '' : $this->Users_model->get_user_resume($where);
