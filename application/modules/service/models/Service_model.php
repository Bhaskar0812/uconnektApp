    ...
    */
    ...
    function userInfo($where){
            ...
            if($userType->userType == 'business'){
                    $this->db->select('u.userId,u.isVerified,u.fullName,u.businessName,u.email,u.userType,u.authToken,u.status,u.crd,u.deviceToken,u.deviceType,u.isProfile,u.isNotify,COALESCE(job.jobTitleName,"") as jobTitleName,COALESCE(CEIL(AVG(r.rating)/0.5) * 0.5, "") as rating,COALESCE(aos.specializationName,"") as specializationName,
                ...
                $this->db->select('u.userId,u.isVerified,u.fullName,u.businessName,u.email,u.userType,u.authToken,u.status,u.crd,u.deviceToken,u.deviceType,u.isProfile,u.isNotify,COALESCE(aos.specializationName,"") as specializationName,COALESCE(job.jobTitleName,"") as jobTitleName,
