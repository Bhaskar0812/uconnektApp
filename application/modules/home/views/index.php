            ...
            <div class="row">
                <div class="col-md-6 col-sm-6">
                    <div class="hero-caption">
                        <h1 class="hero-title">Welcome to ConnektUs</h1>
                        <h5>Hiring. Made. Simple.</h5>
                        <p>ConnektUs is a mobile platform that simplifies the hiring process by allowing active Job Seekers and Employers to conveniently connekt. Find suitable candidates at your finger-tips with our in-depth and specific search capabilities. Want to find specific candidates close to you? Check out our custom map! Finding candidates has never been so simple.</p>
                        <div class="hero-button-area">
                            <a href="#download-area" class="smoothscroll btn btn-default btn-outline">Download</a>
                        </div>
                    </div>
...
<section class="SubscribeSec">
    ...
    <div class="features-area inner-padding about-area-green" id="features-area">
        <div class="container">
            ...
            <div class="col-lg-6">
              <img class="img-responsive hidden-md hidden-xs hidden-sm" src="<?php echo base_url().UC_ASSETS_IMG;?>feturedImage.png" alt="2mobiles">
            </div>
                ...
                <div class="col-xs-12 col-md-6 col-sm-6">
                    <div class="section-title-white wow fadeIn text-left">
                        ...
                        <div class="downloadStore">
                            <a href="#"><img src="<?php echo base_url().UC_ASSETS_IMG;?>appstore.png"></a>
                            <a href="#"><img src="<?php echo base_url().UC_ASSETS_IMG;?>playstore.png"></a>
                        </div>
                    </div>
                </div>
                <div class="col-xs-12 col-md-6 col-sm-6">
                    <div class="appdownloadImg">
                        <img class="pulse" src="<?php echo base_url().UC_ASSETS_IMG;?>download-app.png">
                    </div>
                </div>
            </div>
        </div>
