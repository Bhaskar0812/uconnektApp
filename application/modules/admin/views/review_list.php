                             ...
                             <fieldset class="ratings-only-view" style="margin-top: -15px;">
                                <?php if(!empty($total_rating)){
                                   $rating__input_value =  rating_show();
                                    ...
                                    ?>
                                    <input type="radio"  id="update_<?php echo $valu['input']['id'].$val->reviewId;?>" name="rating<?php echo $valu['input']['id'].$val->reviewId;?>" value=" <?php echo $valu['input']['value'];?>" <?php echo $checked;?> disabled/>
