                    ...
                    <div class="tab-content ">
                        ...
                        <div class="box box-default collapsed-box box-solid">
                          ...
                          <div class="box-body jobBox">
                            ...
                            <div class="form-group">
                              ...
                              <div class="col-md-9">
                                ...
                                <div class="form-group">
                                  ...
                                  <div class="col-md-9">
                                      <input type="text" class="form-control" value="<?php echo display_placeholder_text(floatval($detail['experience']->currentExperience)); ?> Years" readonly/>
                                  </div>
                            </div>  
                            ...
                            <div class="form-group">
                                  ...
                                  <div class="col-md-9">
                                      <input type="text" class="form-control" value="<?php echo display_placeholder_text(floatval($detail['experience']->totalExperience)); ?> Years" readonly/>
                                  </div>
                            </div> 
                        ...
                        <div class="box-body jobBox">
                          ...
                          <div class="form-group">
                            <label class="col-md-3 control-label">Experience</label>
                            <div class="col-md-9">
                            <input type="text" class="form-control" value="<?php echo display_placeholder_text(floatval($prev->experience))." Years"; ?>" readonly/>
                            </div>
                          </div>
