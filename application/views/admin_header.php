...
<head>
  ...
  <!-- Theme style -->
  <link rel="stylesheet" href="<?php echo base_url().ADMIN_THEME; ?>dist/css/AdminLTE.css">
  <!-- Material Design -->
  ...
  <link href="<?php echo base_url().ADMIN_THEME; ?>custom/css/admin_custom.css" rel="stylesheet">
...
<div class="wrapper">
  ...
  <header class="main-header">  
   ...
   <a href="<?php echo base_url(); ?>admin/Dashboard" class="logo">
      ...
      <span class="logo-mini"><img style="max-width:62px;"  src="<?php echo base_url().ADMIN_THEME.'assets/img/3.png';?>" class="user-image" alt=".."></span>
      <!-- logo for regular state and mobile devices -->
      <span class="logo-lg"><img style="max-width: 143px;position:  relative;bottom: 43px;"  src="<?php echo base_url().ADMIN_THEME.'assets/img/1.png';?>" class="user-image" alt=".."></span>
    </a>
